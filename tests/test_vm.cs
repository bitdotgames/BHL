  ...
  public void TestMultiReturnBug()
  {
    ...
    var expected =
        new ModuleCompiler()
          ...
          .EmitChain(Opcodes.SetVarS, new int[] { 0 })
          .EmitChain(Opcodes.SetVarS, new int[] { 1 })
          .EmitChain(Opcodes.Return)
      ;
    AssertEqual(c, expected);
  ...
  public void TestForeachLoop()
  {
    ...
    var expected =
        new ModuleCompiler()
          ...
          .EmitChain(Opcodes.GetVarS, new int[] { 4 })
          ...
          .EmitChain(Opcodes.SetVarS, new int[] { 2 })
          .EmitChain(Opcodes.GetVarS, new int[] { 1 }) //accum = accum + iterator var
          .EmitChain(Opcodes.GetVarS, new int[] { 2 })
          .EmitChain(Opcodes.Add)
          .EmitChain(Opcodes.SetVarS, new int[] { 1 })
