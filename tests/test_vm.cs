...
public class TestVM : BHL_TestBase
{
  ...
  public void TestReturnNumConstant()
  {
    ...
    Assert.False(vm.Tick());
    Assert.Equal(fb.result.PopRelease().num, 123);
    CommonChecks(vm);
  }
  ...
  public void TestFailureBeforeReturn()
  {
    ...
    var fb = vm.Start("test");
    vm.Tick();
    Assert.Equal(fb.status, BHS.FAILURE);
    CommonChecks(vm);
  }
  ...
  public void TestReturnDefaultVar()
  {
    ...
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    Assert.Equal(fb.result.PopRelease().num, 0);
    CommonChecks(vm);
  }
  ...
  public void TestReturnVar()
  {
    ...
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    Assert.Equal(fb.result.PopRelease().num, 42);
    CommonChecks(vm);
  }
...
-------------^"
  ...
  public void TestReturnMultiple4FromBindings()
  {
    ...
    var vm = MakeVM(bhl, ts_fn);
    var fb = Execute(vm, "test");
    Assert.Equal(fb.result.PopRelease().num, 104);
    AssertEqual(fb.result.PopRelease().str, "foo");
    Assert.Equal(fb.result.PopRelease().num, 12);
    Assert.Equal(fb.result.PopRelease().num, 42.5);
    CommonChecks(vm);
  }
...
------^"
  ...
  public void TestFuncPtrReturnNonConsumed()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(Execute(vm, "test").result.PopRelease().num, 2);
    CommonChecks(vm);
  }
...
------^"
  ...
  public void TestLogicalAnd()
  {
    ...
    Assert.Equal(c.compiled.constants.Count, 2);

    var vm = MakeVM(c);
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    Assert.True(fb.result.PopRelease().bval == false);
    CommonChecks(vm);
  }
  ...
  public void TestBitOr()
  {
    ...
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    Assert.Equal(fb.result.PopRelease().num, 7);
    CommonChecks(vm);
  }
  ...
  public void TestModDouble()
  {
    ...
    Assert.Equal(fb.result.PopRelease().num, expectedNum);
    CommonChecks(vm);
  }
...
-------^"
  ...
  public void TestSimpleExpression()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(Execute(vm, "test", Val.NewNum(vm, 3)).result.PopRelease().num, 1);
    CommonChecks(vm);
  }
...
------------^"
  ...
  public void TestWriteReadVar()
  {
    ...
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    Assert.Equal(fb.result.PopRelease().num, 246);
    CommonChecks(vm);
  }
  ...
  public void TestLocalVariables()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(Execute(vm, "test", Val.NewNum(vm, 3)).result.PopRelease().num, 45);
    CommonChecks(vm);
  }
  ...
  public void TestLocalVarHiding()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(Execute(vm, "test").result.PopRelease().num, 100);
    CommonChecks(vm);
  }
...
----------------^"
  ...
  public void TestDeclVarBoolWithoutValue()
  {
    ...
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    Assert.False(fb.result.PopRelease().bval);
    CommonChecks(vm);
  }
  ...
  public void TestAdd()
  {
    ...
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    Assert.Equal(fb.result.PopRelease().num, 30);
    CommonChecks(vm);
  }
  ...
  public void TestMultiply()
  {
    ...
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    Assert.Equal(fb.result.PopRelease().num, 200);
    CommonChecks(vm);
  }
  ...
  public void TestConstantWithBigIndex()
  {
    ...
    Assert.Equal(c.compiled.constants.Count, 260);

    var vm = MakeVM(c);
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    Assert.Equal(fb.result.PopRelease().num, 33930);
    CommonChecks(vm);
  }
  ...
  public void TestAddSameConstants()
  {
    ...
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    Assert.Equal(fb.result.PopRelease().num, 20);
    CommonChecks(vm);
  }
...
------^"
  ...
  public void TestParenthesisExpression()
  {
    ...
    Assert.Equal(c.compiled.constants.Count, 3);

    var vm = MakeVM(c);
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    Assert.Equal(fb.result.PopRelease().num, 500);
    CommonChecks(vm);
  }
...
---------^"
  ...
  public void TestIfCondition()
  {
    ...
    Assert.Equal(c.compiled.constants.Count, 4);
  ...
  public void TestIfElseCondition()
  {
    ...
    Assert.Equal(c.compiled.constants.Count, 5);
  ...
  public void TestMultiIfElseCondition()
  {
    ...
    Assert.Equal(c.compiled.constants.Count, 7);
...
-------------^"
  ...
  public void TestBreakInWhile()
  {
    ...
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    Assert.Equal(fb.result.PopRelease().num, 70);
    CommonChecks(vm);
  }
...
---------------^"
  ...
  public void TestVarInInfiniteLoop()
  {
    ...
    for(int i=0;i<5;++i)
      vm.Tick();
    Assert.Equal(vm.vals_pool.MissCount, 5);
    Assert.Equal(vm.vals_pool.IdleCount, 3);
  ...
  public void TestStackInInfiniteLoop()
  {
    ...
    for(int i=0;i<5;++i)
      vm.Tick();
    Assert.Equal(fb.result.Count, 0);
    Assert.Equal(vm.vals_pool.MissCount, 4);
    Assert.Equal(vm.vals_pool.IdleCount, 3);
  ...
  public void TestSeveralForLoops()
  {
    ...
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    Assert.Equal(fb.result.PopRelease().num, 4);
    CommonChecks(vm);
  }
  ...
  public void TestForLoopLocalScope()
  {
    ...
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    Assert.Equal(fb.result.PopRelease().num, 5);
    CommonChecks(vm);
  }
...
---------------^"
  ...
  public void TestBreakInForLoop()
  {
    ...
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    Assert.Equal(fb.result.PopRelease().num, 9);
    CommonChecks(vm);
  }
...
------^"
  ...
  public void TestInfiniteLoopBreak()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(Execute(vm, "test").result.PopRelease().num, 3);
    CommonChecks(vm);
  }
  ...
  public void TestBreakFromNestedSequences()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(Execute(vm, "test").result.PopRelease().num, 1);
    CommonChecks(vm);
  }
  ...
  public void TestMultiFuncCall()
  {
    ...
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    Assert.Equal(fb.result.PopRelease().num, 125);
    CommonChecks(vm);
  }
  ...
  public void TestDefaultFuncOtherFunc()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(10 + 1, Execute(vm, "test").result.PopRelease().num);
    CommonChecks(vm);
  }
...
-----------------------^"
  ...
  public void TestPassByRefNullValue()
  {
    ...
    Assert.Equal(num1, 12);
    Assert.Equal(num2, 11);
    CommonChecks(vm);
  }
...
----------------^"
  ...
  public void TestDetachFiber()
  {
    ...
    var vm = MakeVM(bhl);
    var fb = vm.Start("test");
    Assert.Equal(fb.status, BHS.NONE);
    vm.Detach(fb);
    Assert.Equal(fb.status, BHS.NONE);
    Assert.False(vm.Tick());
    Assert.Equal(fb.status, BHS.NONE);
  ...
  public void TestDetachAndTickSeveralFibers()
  {
    ...
    Assert.Equal(fbs.Count, 2);

    Assert.True(vm.Tick(fbs));
    Assert.Equal(fbs.Count, 2);

    Assert.True(vm.Tick(fbs));
    Assert.Equal(fbs.Count, 1);

    Assert.False(vm.Tick(fbs));
    Assert.Equal(fbs.Count, 0);
  ...
  public void TestCleanFuncArgsStackOnFailure()
  {
    ...
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    Assert.Equal(0, fb.result.Count);
    CommonChecks(vm);
  }
...
-------------^"
  ...
  public void TestOperatorTernaryIf()
  {
    ...
    Assert.Equal(Execute(vm, "test1").result.PopRelease().num, 100500);
    Assert.Equal(Execute(vm, "test2").result.PopRelease().num, 100500);
  ...
  public void TestOperatorPostfixIncrementCall()
  {
    ...
    Assert.Equal(Execute(vm, "test1").result.PopRelease().num, 0);
...
-------------^"
  ...
  public void TestStartSeveralFibers()
  {
    ...
    Assert.True(vm.Tick());
    Assert.False(vm.Tick());
    Assert.Equal(fb1.result.PopRelease().num, 123);
    Assert.Equal(fb2.result.PopRelease().num, 123);
    CommonChecks(vm);
  }
  ...
  public void TestRegisterModule()
  {
    ...
    var vm = new VM();
    vm.LoadModule(c);
    Assert.Equal(Execute(vm, "test").result.PopRelease().num, 123);
    CommonChecks(vm);
  }
  ...
  public void TestLoadModuleTwice()
  {
    ...
    Assert.Equal(Execute(vm, "bhl1").result.PopRelease().num, 23);
  ...
  public void TestGlobalVariableAssignAndReadArray()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(200, Execute(vm, "test").result.PopRelease().num);
    CommonChecks(vm);
  }
  ...
  public void TestGlobalVariableWrite()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(101, Execute(vm, "test").result.PopRelease().num);
    CommonChecks(vm);
  }
...
--------------------------^"
  ...
  public void TestValListOwnership()
  {
...

    {
      ...
      lst.Add(dv0);
      lst.Add(dv1);
      Assert.Equal(dv0._refs, 1);
      Assert.Equal(dv1._refs, 1);
