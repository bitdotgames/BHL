...
public class TestTypeCasts : BHL_TestBase
{
  ...
  public void TestBoolToIntTypeCast()
  {
    ...
    var expected =
        new ModuleCompiler()
          ...
          .EmitChain(Opcodes.TypeCast, new int[] { TypeIdx(c, ts.T("int")), 0 })
  ...
  public void TestIntToStringTypeCast()
  {
    ...
    var expected =
        new ModuleCompiler()
          ...
          .EmitChain(Opcodes.TypeCast, new int[] { TypeIdx(c, ts.T("string")), 1 })
          .EmitChain(Opcodes.Return)
      ;
    AssertEqual(c, expected);
    ...
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    AssertEqual(fb.result_old.PopRelease().str, "7");
    CommonChecks(vm);
  }
  ...
  public void TestCastFloatToStr()
  {
    ...
    var vm = MakeVM(bhl);
    var str = ExecuteOld(vm, "test", ValOld.NewNum(vm, 3)).result_old.PopRelease().str;
    AssertEqual(str, "3");
    CommonChecks(vm);
  }
...
---------------------^"
  ...
  public void TestCastFloatToInt()
  {
    ...
    var vm = MakeVM(bhl);
    var res = ExecuteOld(vm, "test", ValOld.NewFlt(vm, 3.9)).result_old.PopRelease().num;
    Assert.Equal(3, res);
    CommonChecks(vm);
  }
  ...
  public class TestIsForChildNativeClass : BHL_TestBase
  {
    ...
    {
      var vm = MakeVM(bhl, ts_fn);
      Assert.True(Execute(vm, "test2").result_old.PopRelease().bval);
      CommonChecks(vm);
    }
    ...
    {
      var vm = MakeVM(bhl, ts_fn);
      Assert.Equal(100, Execute(vm, "test3").result_old.PopRelease().num);
      CommonChecks(vm);
    }
  }
  ...
  public class TestAsForChildClass : BHL_TestBase
  {
    ...
    {
      var vm = MakeVM(bhl);
      Assert.Equal(41, Execute(vm, "test3").result_old.PopRelease().num);
      CommonChecks(vm);
    }
  }
...
----------------^"
  ...
  {
    {
      ...
      var vm = MakeVM(bhl);
      AssertEqual("hey", Execute(vm, "test").result_old.PopRelease().str);
      CommonChecks(vm);
    }
  ...
  {
    {
      ...
      var vm = MakeVM(bhl);
      AssertEqual("wow", Execute(vm, "test").result_old.PopRelease().str);
      CommonChecks(vm);
    }
  ...
  public void TestInterfaceAs()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(42 + 24, Execute(vm, "test").result_old.PopRelease().num);
    CommonChecks(vm);
  }
  ...
  {
    {
      ...
      var vm = MakeVM(bhl);
      AssertEqual("int", Execute(vm, "test").result_old.PopRelease().str);
      CommonChecks(vm);
    }

    {
      ...
      var vm = MakeVM(bhl);
      AssertEqual("string", Execute(vm, "test").result_old.PopRelease().str);
      CommonChecks(vm);
    }

    {
      ...
      var vm = MakeVM(bhl);
      AssertEqual("func void()", Execute(vm, "test").result_old.PopRelease().str);
      CommonChecks(vm);
    }
