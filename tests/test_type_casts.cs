...
public class TestTypeCasts : BHL_TestBase
{
  ...
  public void TestIntToStringTypeCast()
  {
    ...
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    AssertEqual(fb.Stack.Pop().str, "7");
    CommonChecks(vm);
  }
...
---------------------^"
  ...
  public void TestSimpleIs()
  {
    ...
    var expected =
        new ModuleCompiler()
          ...
          .EmitChain(Opcodes.SetVarScalar, new int[] { 0 })
  ...
  public void TestSimpleAsForSelf()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(14, Execute(vm, "test").Stack.Pop().num);
    CommonChecks(vm);
  }
  ...
  public class TestIsForChildNativeClass : BHL_TestBase
  {
    ...
    {
      var vm = MakeVM(bhl, ts_fn);
      Assert.True(Execute(vm, "test2").Stack.Pop().bval);
      CommonChecks(vm);
    }
    ...
    {
      var vm = MakeVM(bhl, ts_fn);
      Assert.Equal(100, Execute(vm, "test3").Stack.Pop().num);
      CommonChecks(vm);
    }
  }
  ...
  public class TestAsForChildClass : BHL_TestBase
  {
    ...
    {
      var vm = MakeVM(bhl);
      Assert.Equal(41, Execute(vm, "test").Stack.Pop().num);
      CommonChecks(vm);
    }
    ...
    {
      var vm = MakeVM(bhl);
      Assert.Equal(14, Execute(vm, "test2").Stack.Pop().num);
      CommonChecks(vm);
    }
    ...
    {
      var vm = MakeVM(bhl);
      Assert.Equal(41, Execute(vm, "test3").Stack.Pop().num);
      CommonChecks(vm);
    }
  }
...
----------------^"
  ...
  {
    {
      ...
      var vm = MakeVM(bhl);
      AssertEqual("hey", Execute(vm, "test").Stack.Pop().str);
      CommonChecks(vm);
    }
  ...
  {
    {
      ...
      var vm = MakeVM(bhl);
      AssertEqual("wow", Execute(vm, "test").Stack.Pop().str);
      CommonChecks(vm);
    }
  ...
  public void TestInterfaceAs()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(42 + 24, Execute(vm, "test").Stack.Pop().num);
    CommonChecks(vm);
  }
  ...
  {
    {
      ...
      var vm = MakeVM(bhl);
      AssertEqual("int", Execute(vm, "test").Stack.Pop().str);
      CommonChecks(vm);
    }

    {
      ...
      var vm = MakeVM(bhl);
      AssertEqual("string", Execute(vm, "test").Stack.Pop().str);
      CommonChecks(vm);
    }

    {
      ...
      var vm = MakeVM(bhl);
      AssertEqual("func void()", Execute(vm, "test").Stack.Pop().str);
      CommonChecks(vm);
    }
