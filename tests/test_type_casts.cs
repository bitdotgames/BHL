...
public class TestTypeCasts : BHL_TestBase
{
  ...
  public void TestBoolToIntTypeCast()
  {
    ...
    var expected = 
      ...
      .EmitThen(Opcodes.TypeCast, new int[] { ConstIdx(c, ts.ns.T("int")) })
  ...
  public void TestSimpleIs()
  {
    ...
    var expected = 
      ...
      .EmitThen(Opcodes.TypeIs, new int[] { ConstIdx(c, ts.ns.T("int")) })
      .EmitThen(Opcodes.ReturnVal, new int[] { 1 })
      .EmitThen(Opcodes.Return)
      ;
    AssertEqual(c, expected);
  ...
  public void TestSimpleAsForSelf()
  {
    ...
    var expected = 
      ...
      .EmitThen(Opcodes.SetVar, new int[] { 0 })
      .EmitThen(Opcodes.GetVar, new int[] { 0 })
      .EmitThen(Opcodes.TypeAs, new int[] { ConstIdx(c, ts.ns.T("Foo")) })
