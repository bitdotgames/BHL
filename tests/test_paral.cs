  ...
  public void TestSubParalAutoSeqWrap()
  {
    ...
    var expected =
        new ModuleCompiler()
          ...
          .EmitThen(Opcodes.InitFrame, new int[] { 1, 1 })
          .EmitThen(Opcodes.DeclVar, new int[] { 0, TypeIdx(c, ts.T("int")) })
          .EmitThen(Opcodes.Paral, new int[] { 48 })
          .EmitThen(Opcodes.Scope, new int[] { 8 })
          .EmitThen(Opcodes.CallGlobNative, new int[] { ts.module.nfunc_index.IndexOf("suspend"), 0})
          .EmitThen(Opcodes.Scope, new int[] { 23 })
          .EmitThen(Opcodes.Paral, new int[] { 20 })
          .EmitThen(Opcodes.Scope, new int[] { 8 })
          .EmitThen(Opcodes.CallGlobNative, new int[] { ts.module.nfunc_index.IndexOf(Prelude.YieldFunc), 0 })
          .EmitThen(Opcodes.Scope, new int[] { 6 })
          .EmitThen(Opcodes.Constant, new int[] { ConstIdx(c, 1) })
          .EmitThen(Opcodes.SetVar, new int[] { 0 })
          .EmitThen(Opcodes.Scope, new int[] { 8 })
          .EmitThen(Opcodes.CallGlobNative, new int[] { ts.module.nfunc_index.IndexOf("suspend"), 0})
  ...
  public void TestSubParalAutoSeqWrapLambda()
  {
    ...
    var expected =
        new ModuleCompiler()
          .UseCode()
          .EmitThen(Opcodes.InitFrame, new int[] { 1, 1 })
          .EmitThen(Opcodes.DeclRef, new int[] { 0 })
          .EmitThen(Opcodes.Paral, new int[] { 69 })
          .EmitThen(Opcodes.Scope, new int[] { 8 })
          .EmitThen(Opcodes.CallGlobNative, new int[] { ts.module.nfunc_index.IndexOf("suspend"), 0})
          .EmitThen(Opcodes.Scope, new int[] { 44 })
          .EmitThen(Opcodes.Lambda, new int[] { 27 })
