...
------------------^"
  ...
  public void TestStartFuncByPath()
  {
    ...
    ";
    var vm = MakeVM(bhl);
    Assert.Equal(1, Execute(vm, "foo.test").Stack.Pop().num);
    Assert.Equal(0, Execute(vm, "bar.test").Stack.Pop().num);
    CommonChecks(vm);
  }
  ...
  {
    {
      ...
      ";
      var vm = MakeVM(bhl);
      Assert.Equal(1, Execute(vm, "bar.test").Stack.Pop().num);
      CommonChecks(vm);
    }

    {
      ...
      ";
      var vm = MakeVM(bhl);
      Assert.Equal(11, Execute(vm, "bar.test").Stack.Pop().num);
      CommonChecks(vm);
    }
  }
  ...
  public async Task TestMixNativeAndUserland()
  {
    ...
    Assert.Equal(1, Execute(vm, "bar.wow").Stack.Pop().num);
    CommonChecks(vm);
  }
  ...
  public void TestPreferLocalVersion()
  {
    ...
    ";
    var vm = MakeVM(bhl);
    Assert.Equal(10, Execute(vm, "foo.test").Stack.Pop().num);
    CommonChecks(vm);
  }
...
";
  ...
  public void TestUserClasses()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(114.5, Execute(vm, "test").Stack.Pop().num);
    CommonChecks(vm);
  }
...
-----------------^"
  ...
  public async Task TestImportSeveralNestedNamespacesWithSameLastName()
  {
    ...
    vm.LoadModule("bhl2");
    Assert.Equal(120, Execute(vm, "test").Stack.Pop().num);
    CommonChecks(vm);
  }
