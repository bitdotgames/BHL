...
public class TestArrays : BHL_TestBase
{
  ...
  public void TestAddToStringArray()
  {
    ...
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    AssertEqual(fb.result_old.PopRelease().str, "test");
    CommonChecks(vm);
  }
  ...
  public void TestTmpArrayCount()
  {
    ...
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    Assert.Equal(2, fb.result_old.PopRelease().num);
    CommonChecks(vm);
  }
  ...
  public void TestArrayPassedToFuncIsChanged()
  {
    ...
    var fb = vm.Start("test");
    Assert.False(vm.Tick());
    Assert.Equal(100, fb.result_old.PopRelease().num);
    CommonChecks(vm);
  }
