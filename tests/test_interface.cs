...
public class TestInterfaces : BHL_TestBase
{
  ...
  public void TestEmptyUserInterface()
  {
    ...
    var vm = MakeVM(bhl);
    var symb = vm.ResolveFullName("Foo") as InterfaceSymbolScript;
  ...
  public void TestUserInterfaceInheritance()
  {
    ...
    {
      var symb = vm.ResolveFullName("Wow") as InterfaceSymbolScript;
      AssertTrue(symb != null);
  ...
  {
    {
      ...
      ";
      var vm = MakeVM(bhl);
      var symb = vm.ResolveFullName("Foo") as ClassSymbol;
      AssertTrue(symb != null);
  ...
  {
    {
      ...
      var expected = 
        ...
        .EmitThen(Opcodes.CallMethodVirt, new int[] { 0, ConstIdx(c, ts.T("IFoo")), 1 })
        .EmitThen(Opcodes.ReturnVal, new int[] { 1 })
        .EmitThen(Opcodes.Return)
        ;
