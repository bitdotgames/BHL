...
----------------^"
  ...
  public void TestUserClassMemberOperations()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(102, Execute(vm, "test").result_old.PopRelease().num);
    CommonChecks(vm);
  }
  ...
  public void TestUserSeveralClassMembersOperations()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(113.5, Execute(vm, "test").result_old.PopRelease().num);
    CommonChecks(vm);
  }
...
--------^"
  ...
  public async Task TestImportClassMoreComplex()
  {
    ...
    vm.LoadModule("bhl1");
    Assert.Equal(42, Execute(vm, "test", ValOld.NewNum(vm, 42)).result_old.PopRelease().num);
    CommonChecks(vm);
  }
...
-------^"
  ...
  public void TestUserClassWithAnotherUserClassMember()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(21, Execute(vm, "test").result_old.PopRelease().num);
    CommonChecks(vm);
  }
  ...
  public void TestUserClassDefaultInitStringConcat()
  {
    ...
    var vm = MakeVM(bhl);
    AssertEqual("", Execute(vm, "test").result_old.PopRelease().str);
    CommonChecks(vm);
  }
...
------------^"
  ...
  public void TestDefaultArgValueInMethod()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(22, Execute(vm, "test").result_old.PopRelease().num);
    CommonChecks(vm);
  }
...
----------------^"
  ...
  public void TestUserClassAndLocalVariableOwnership()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(1, Execute(vm, "test1").result_old.PopRelease().num);
    Assert.Equal(1, Execute(vm, "test2").result_old.PopRelease().num);
    CommonChecks(vm);
  }
...
------^"
  ...
  public void TestArrayOfUserClasses()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(33, Execute(vm, "test").result_old.PopRelease().num);
    CommonChecks(vm);
  }
...
------------------^"
  ...
  public void TestNativeClassCallMember()
  {
    ...
    var vm = MakeVM(bhl, ts_fn);
    var res = Execute(vm, "test", ValOld.NewNum(vm, 10)).result_old.PopRelease().num;
    Assert.Equal(10, res);
    res = Execute(vm, "test", ValOld.NewNum(vm, 20)).result_old.PopRelease().num;
    Assert.Equal(20, res);
    CommonChecks(vm);
  }
...
-----------------------^"
  ...
  public void TestBasicVirtualMethodsSupport()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(110, Execute(vm, "test1").result_old.PopRelease().num);
    Assert.Equal(110, Execute(vm, "test2").result_old.PopRelease().num);
    Assert.Equal(200, Execute(vm, "test3").result_old.PopRelease().num);
    CommonChecks(vm);
  }
...
--------^"
  ...
  public void TestVirtualOverrideIn3dChild()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(210, Execute(vm, "test1").result_old.PopRelease().num);
    Assert.Equal(210, Execute(vm, "test2").result_old.PopRelease().num);
    Assert.Equal(210, Execute(vm, "test3").result_old.PopRelease().num);
    CommonChecks(vm);
  }
  ...
  ";
    ...
    vm.LoadModule("bhl2");
    Assert.Equal(100 + 1000, Execute(vm, "test").result_old.PopRelease().num);
    CommonChecks(vm);
  }
...
----^"
  ...
  ";
    ...
    vm.LoadModule("bhl2");
    Assert.Equal(2, Execute(vm, "test1").result_old.PopRelease().num);
    CommonChecks(vm);
  }
  ...
  public void TestMixInterfaceWithVirtualMethodAndCasting()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(12, Execute(vm, "test1").result_old.PopRelease().num);
    Assert.Equal(12, Execute(vm, "test2").result_old.PopRelease().num);
    CommonChecks(vm);
  }
  ...
  public void TestSimpleNestedClass()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(31, Execute(vm, "test").result_old.PopRelease().num);
    CommonChecks(vm);
  }
  ...
  public void TestSubNestedClassMethods()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(81, Execute(vm, "test").result_old.PopRelease().num);
    CommonChecks(vm);
  }
  ...
  public void TestSimpleStaticMethodWithArgs()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(42 + 10 + 100, Execute(vm, "test").result_old.PopRelease().num);
    CommonChecks(vm);
  }
  ...
  public void TestSimpleStaticMethodMixed()
  {
    ...
    var vm = MakeVM(bhl);
    Assert.Equal(42 + 10 + 20, Execute(vm, "test").result_old.PopRelease().num);
    CommonChecks(vm);
  }
...
-------------------^"
  ...
  public async Task TestStaticFieldImportedMixWithGlobalVars()
  {
    ...
    vm.LoadModule("bhl2");
    Assert.Equal(10 + 20 + 30 + 42, Execute(vm, "test").result_old.PopRelease().num);
    CommonChecks(vm);
  }
  ...
  public class TestNestedNativeClassesIrrelevantOrder : BHL_TestBase
  {
    ...
    public void _1()
    {
      ...
      var vm = MakeVM(bhl, ts_fn);
      Assert.Equal(1110, Execute(vm, "test").result_old.PopRelease().num);
      CommonChecks(vm);
    }
