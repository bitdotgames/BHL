  ...
  public void TestJsonInitForUserClass()
  {
    ...
    var expected =
        new ModuleCompiler()
          ...
          .EmitChain(Opcodes.SetAttrInplace, new int[] { 1 })
          .EmitChain(Opcodes.Constant, new int[] { ConstIdx(c, "Hey") })
          .EmitChain(Opcodes.SetAttrInplace, new int[] { 2 })
          ...
          .EmitChain(Opcodes.GetVarAttr, new int[] { 0, 1 })
          .EmitChain(Opcodes.TypeCast, new int[] { TypeIdx(c, c.ns.T("string")), 1 })
          .EmitChain(Opcodes.Concat)
          .EmitChain(Opcodes.Constant, new int[] { ConstIdx(c, ";") })
          .EmitChain(Opcodes.Concat)
...
------------------^"
  ...
  public void TestJsonArrInitForUserClass()
  {
    ...
    var expected =
        new ModuleCompiler()
          ...
          .EmitChain(Opcodes.Constant, new int[] { ConstIdx(c, "Hey") })
          .EmitChain(Opcodes.SetAttrInplace, new int[] { 2 })
          .EmitChain(Opcodes.ArrAddInplace)
          .EmitChain(Opcodes.SetVar, new int[] { 0 })
          ...
          .EmitChain(Opcodes.GetVarAttr, new int[] { 1, 0 })
          .EmitChain(Opcodes.TypeCast, new int[] { TypeIdx(c, c.ns.T("string")), 1 })
          .EmitChain(Opcodes.Constant, new int[] { ConstIdx(c, ";") })
          .EmitChain(Opcodes.Concat)
          .EmitChain(Opcodes.GetVarAttr, new int[] { 1, 1 })
          .EmitChain(Opcodes.TypeCast, new int[] { TypeIdx(c, c.ns.T("string")), 1 })
          .EmitChain(Opcodes.Concat)
          .EmitChain(Opcodes.Constant, new int[] { ConstIdx(c, ";") })
          .EmitChain(Opcodes.Concat)
  ...
  public void TestJsonArrComplexCtor()
  {
    ...
    var vm = MakeVM(bhl, ts_fn);
    Assert.Equal(1111, Execute(vm, "test").Stack.Pop().num);
    CommonChecks(vm);
  }
  ...
  public void TestJsonDefaultArgWithOtherDefaultArgs()
  {
    ...
    var vm = MakeVM(bhl, ts_fn);
    Assert.Equal(40, Execute(vm, "test").Stack.Pop().num);
    CommonChecks(vm);
  }
...
---------------------^"
  ...
  public void TestJsonArrayExplicit()
  {
    ...
    var vm = MakeVM(bhl, ts_fn);
    Assert.Equal(114, Execute(vm, "test").Stack.Pop().num);
    CommonChecks(vm);
  }
...
-----------------------------------------^"
  ...
  public void TestJsonMasterStructWithClass()
  {
    ...
    var vm = MakeVM(bhl, ts_fn);
    Assert.Equal("hey2", Execute(vm, "test").Stack.Pop().str);
    CommonChecks(vm);
  }
