...
public class TestMarshall : BHL_TestBase
{
  ...
  public void TestSerializeModuleSymbols()
  {
...

    {
      ...
      AssertEqual(2, Test.GetArgs().Count);
      AssertEqual("a", Test.GetArgs()[0].name);
      AssertTrue(((FuncArgSymbol)Test.GetArgs()[0]).is_ref);
      AssertEqual(Types.Int, ((FuncArgSymbol)Test.GetArgs()[0]).type.Get());
      AssertEqual("s", Test.GetArgs()[1].name);
      AssertFalse(((FuncArgSymbol)Test.GetArgs()[1]).is_ref);
      AssertEqual(Types.String, ((FuncArgSymbol)Test.GetArgs()[1]).type.Get());
      ...
      AssertEqual("bar", Make.GetArgs()[0].name);
      AssertFalse(((FuncArgSymbol)Make.GetArgs()[0]).is_ref);
      AssertEqual(ns.T("Bar").Get(), ((FuncArgSymbol)Make.GetArgs()[0]).type.Get());
      ...
      AssertEqual(1, Make.GetArgs().Count);
