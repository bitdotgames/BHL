...
using unsafe BytecodeHandler = delegate*<
  VM, VM.ExecState, ref VM.Region, ref VM.Frame, byte*, void
>;
...
public partial class VM
{
  ...
  static readonly unsafe BytecodeHandler[] op_handlers = new BytecodeHandler[(int)Opcodes.MAX];
  ...
  unsafe static void OpcodeAdd(VM vm, ExecState exec, ref Region region, ref Frame frame, byte* bytes)
  {
    ...
    //  l_operand.obj = (string)l_operand.obj + (string)r_operand.obj;
    //else
      l_operand._long0 += r_operand._long0;
  }
