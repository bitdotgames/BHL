...
public abstract class ArrayTypeSymbol : ClassSymbol
{
  ...
  Coroutine BindRemoveAt(VM.ExecState exec, FuncArgsInfo args_info, int ctx_idx)
  {
    var stack = exec.stack;
  ...
  Coroutine BindIndexOf(VM.ExecState exec, FuncArgsInfo args_info, int ctx_idx)
  {
    var stack = exec.stack;
  ...
  Coroutine BindInsert(VM.ExecState exec, FuncArgsInfo args_info, int ctx_idx)
  {
    var stack = exec.stack;
