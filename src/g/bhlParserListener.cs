...
public interface IbhlParserListener : IParseTreeListener {
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterArrType([NotNull] bhlParser.ArrTypeContext context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="bhlParser.arrType"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitArrType([NotNull] bhlParser.ArrTypeContext context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterExpLogicalAnd([NotNull] bhlParser.ExpLogicalAndContext context);
	/// <summary>
	/// Exit a parse tree produced by the <c>ExpLogicalAnd</c>
	/// labeled alternative in <see cref="bhlParser.exp"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitExpLogicalAnd([NotNull] bhlParser.ExpLogicalAndContext context);
	/// <summary>
	/// Enter a parse tree produced by the <c>ExpLogicalOr</c>
	/// labeled alternative in <see cref="bhlParser.exp"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterExpLogicalOr([NotNull] bhlParser.ExpLogicalOrContext context);
	/// <summary>
