...
public partial class bhlBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IbhlVisitor<Result> {
	...
	/// <summary>
	/// Visit a parse tree produced by <see cref="bhlParser.funcCallChain"/>.
	/// <para>
	/// The default implementation returns the result of calling <see cref="AbstractParseTreeVisitor{Result}.VisitChildren(IRuleNode)"/>
	/// on <paramref name="context"/>.
	/// </para>
	...
	/// <param name="context">The parse tree.</param>
	/// <return>The visitor result.</return>
	public virtual Result VisitFuncCallChain([NotNull] bhlParser.FuncCallChainContext context) { return VisitChildren(context); }
	/// <summary>
