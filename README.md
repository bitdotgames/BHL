...
For now there is no any documentation for bhl except presentation slides. However, there are many unit tests in **[tests.cs] (tests.cs)** which cover almost all bhl features.
